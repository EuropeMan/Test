...
namespace vmt {
    ...
    inline T GetVMethod(uint32_t uIndex, void* pClass) {
        if (!pClass) {
            //log_pirnt("Tried getting virtual function from a null class.\n");
            return T{};
        }

        void** pVTable = *static_cast<void***>(pClass);
        if (!pVTable) {
            //log_pirnt("Tried getting virtual function from a null vtable.\n");
            return T{};
        }
    ...
    inline T CallVirtual(uint32_t uIndex, void* pClass, Args... args) {
        ...
        if (!pFunc) {
            //log_pirnt("Tried calling a null virtual function.\n");
            return T{};
        }
